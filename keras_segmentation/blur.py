...
def predict(model=None, inp=None, out_fname=None, checkpoints_path=None, original_size=(0,0)):
...
def evaluate( model=None , inp_images=None , annotations=None,inp_images_dir=None ,annotations_dir=None , checkpoints_path=None ):
    ...
    return {"frequency_weighted_IU":frequency_weighted_IU , "mean_IU":mean_IU , "class_wise_IU(IoU)":cl_wise_score }
